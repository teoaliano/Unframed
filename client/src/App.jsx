...
function Canvas() {
  ...
  // `getViewport` is the editor's: it saves where you were so closing it puts the canvas
  // back exactly there. `deleteElements` is gone with the mid-turn delete confirmation --
  // a chat is not a dependency of the artifact it touched, so nothing asks before deleting.
    ...
    >
      ...
      >
        ...
        <ReactFlow
          ...
          // mouse. pan tool: drag anywhere pans, like a hand tool. The array is hoisted
          // because a fresh literal every render re-renders ReactFlow itself.
