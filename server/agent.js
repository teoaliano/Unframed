...
export const SYSTEM_PROMPT = [
  ...
  'A parameter never writes a property the timeline animates: GSAP owns `transform` on every element it tweens and will overwrite a position the moment the clip is scrubbed, so tune a wrapper the timeline does not touch.',
